    ...
    const fetchData = async () => {
      try {
        ...
        const aggregatedData = data.reduce((acc, curr) => {
          ...
          acc[type].Likes += parseInt(curr.Likes, 10); // Convert to integer
          acc[type].Shares += parseInt(curr.Shares, 10); // Convert to integer
          acc[type].Comments += parseInt(curr.Comments, 10); // Convert to integer
          return acc;
        }, {});
